function [expectedValues,flank1DiffFromExpected,alphaDegNew] =  doCalculateExpectedIntenisties_splineFitStressNorm(funCoords,ratioNormFlank1Tmp,fitresult,testImg,maxMean)
