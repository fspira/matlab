function [fitresult, gof] = createFitSineSquareFixPhase_offset_M21_16714(xComponent, yComponent)
...
ft = fittype( 'a0 + a1*sin(x*(pi/180)-pi/0.5)^2', 'independent', 'x', 'dependent', 'y' );
opts = fitoptions( ft );
opts.Display = 'Off';
opts.Lower = [-Inf -Inf];
