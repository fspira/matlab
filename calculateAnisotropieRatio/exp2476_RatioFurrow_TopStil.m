...
tifFilename = 'cell7_60muMBlebbistatin_notch.lsm';
%tifFilenameMid = 'cell7_conv.tif';

saveFileName = 'cell7_notch';
...
imgOrigGreen = img(:,:,(timeSet));
imgOrigGreen = imgOrigGreen{2};

imgOrigRed = img(:,:,(timeSet));
imgOrigRed = imgOrigRed{1};
