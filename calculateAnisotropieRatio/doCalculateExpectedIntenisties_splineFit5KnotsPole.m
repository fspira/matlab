function [expectedValues,flank1DiffFromExpected,alphaDegNew] =  doCalculateExpectedIntenisties_splineFitStressNormPole(funCoords,ratioNormFlank1Tmp,fitresult,testImg,maxMean)
...
%%%%%% This value is based on the difference between horizontal and
%%%%%% vertical metaphase cells after correction - I will have to go back
%%%%%% to the code for further testing

correctionConstant = 0.1371
      ...
      anisoCorrectionFactor = (maxMean - (feval(fitresult, alphaDegNew(subrun))))
    
   
 
    
        flank1DiffFromExpected(subrun) =  flankCrop1(subrun) + anisoCorrectionFactor + correctionConstant;
