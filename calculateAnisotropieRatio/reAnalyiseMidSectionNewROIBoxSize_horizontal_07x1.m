...
tifFilename= [tifFilename,'_Box07_1'];
%anaOnset = 10;
...
for lauf = 1:length(xFurrow1)
 ...
 [BW_Box BWHor BWVer,imgMergeSaveVertical]=doDrawBoxAtCoordinates_Hor_07_1(x,y,S1_In,voxelX_mum);
 ...
 [BW_Box BWHor BWVer,imgMergeSaveVertical]=doDrawBoxAtCoordinates_Hor_07_1(x,y,imgMergeSaveVertical,voxelX_mum);
 ...
 [BW_Box BWHor BWVer,imgMergeSaveVertical]=doDrawBoxAtCoordinates_Ver_07_1(x,y,imgMergeSaveVertical,voxelX_mum);
