function [fitresult, gof] = createFitSineSquareFixPhase_offset_3720_160713_cell1(xComponent, yComponent)
...
ft = fittype( 'a0 + a1*sin(x*(pi/180)-pi/2.7)^2', 'independent', 'x', 'dependent', 'y' );
opts = fitoptions( ft );
opts.Display = 'Off';
opts.Lower = [-Inf -Inf];
