function [fitresult, gof] = createFitSineSquareFixPhase_offset_3720_16727(xComponent, yComponent)
...
ft = fittype( 'a0 + a1*sin(x*(pi/180)-pi/3.4)^2', 'independent', 'x', 'dependent', 'y' );
opts = fitoptions( ft );
opts.Display = 'Off';
opts.Lower = [-Inf -Inf];
