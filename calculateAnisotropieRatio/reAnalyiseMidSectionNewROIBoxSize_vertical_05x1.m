...
tifFilename= [tifFilename,'_Box05_1'];
%anaOnset = 10
...
for lauf = 1:length(xFurrow1)
 ...
 [BW_Box BWHor BWVer,imgMergeSaveVertical]=doDrawBoxAtCoordinates_Ver(x,y,S1_In,voxelX_mum);
 ...
 [BW_Box BWHor BWVer,imgMergeSaveVertical]=doDrawBoxAtCoordinates_Ver(x,y,imgMergeSaveVertical,voxelX_mum);
 ...
 [BW_Box BWHor BWVer,imgMergeSaveVertical]=doDrawBoxAtCoordinates_Hor(x,y,imgMergeSaveVertical,voxelX_mum);
...
tiffwrite_RBG(saveImg,[tifFilename,'_ROI_05_1.tif']);
