function [fitresult, gof] = createFitPolyFitAngleIntensity_sineWORK(alphaDeg, flankCrop)
...
opts.Lower = [-Inf -Inf -Inf 0.0069];
opts.StartPoint = [0.959492426392903 0.655740699156587 1.636 0.03];
