...
PollDir='D:\Shared Data\Felix\20150503_SirActin_5Frame_dish2\cell3'; % Directory in which overview scan and the data is stored.
fileBase = 'cell1T';
...
mkdir(PollDir)
    ...
    clear s
        ...
        for lauf = 1:TPoints
            ...
            [consistencyFlag] = consistencyCheck(PollDir, expectedFileBase, counter_I0);
...
%             end
            ...
            [consistencyFlag] = consistencyCheck(PollDir, expectedFileBase, counter_I45);
             if consistencyFlag == 1
                disp('Consistency check TRUE')
            else
                disp('Consistency check FALSE')
...
%             end
            ...
            [consistencyFlag] = consistencyCheck(PollDir, expectedFileBase, counter_I90);
             if consistencyFlag == 1
                disp('Consistency check TRUE')
            else
                disp('Consistency check FALSE')
...
%             end
            ...
            [consistencyFlag] = consistencyCheck(PollDir, expectedFileBase, counter_I135);
             if consistencyFlag == 1
                disp('Consistency check TRUE')
            else
                disp('Consistency check FALSE')
            ...
            [consistencyFlag] = consistencyCheck(PollDir, expectedFileBase, counter_I0_Bleach);
             if consistencyFlag == 1
                disp('Consistency check TRUE')
            else
                disp('Consistency check FALSE')
...
ChannelOfInterest=1;
confocalPaths={'D:\Shared Data\Felix\20150503_SirActin_5Frame_dish2\cell1'...
    };
%test = s
