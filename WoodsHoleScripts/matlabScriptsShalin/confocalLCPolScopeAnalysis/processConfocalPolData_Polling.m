    ...
    for idZ=arg.Zslices
        ...
        switch(arg.acqMethod)
            case {'polling','Polling','POLLING'}
             [I0,I45,I90,I135,I0bleach]=getPolChannelsPolling(directory,idF,arg.Channel,arg.prefix,max(arg.Frames));
            otherwise
...
function [I0,I45,I90,I135,I0bleach]=getPolChannelsPolling(directory,Frame,Channel,prefix,totalFrames)  % Change this function as naming convention changes.
