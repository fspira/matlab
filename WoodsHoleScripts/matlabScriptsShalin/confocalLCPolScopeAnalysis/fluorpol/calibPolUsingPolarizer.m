function [StoIMatrix,ItoSMatrix] = calibPolUsingPolarizer(polstack,varargin)%polParams.polType,polParams.center,polParams.maxRadius,polParams.diagnosis)
...
switch(polParams.polType)
    ...
    hTanPolImg=imagecat(Orientation,Anisotropy,Average,...
        CorrectedOrientation,CorrectedAnisotropy,CorrectedAverage,'equal','link','colorbar',hTanPol);
