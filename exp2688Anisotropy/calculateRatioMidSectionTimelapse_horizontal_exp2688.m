...
tifFilename = '3188_None_Mark0001_Tl30s_Movie019.tif';

testImage = tiffread30('polarisation_DE_2_W0001_P0002_T0003.lsm');
voxelX = getfield(testImage,'lsm','VoxelSizeX');
voxelX_mum = voxelX*100000;
%tifFilenameMid = 'cell6_conv.tif';

saveFileName = 'cell3_vertical';
