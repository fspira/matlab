...
tiffwrite_RBG(saveImg,[tifFilename,'2.5_ROI.tif']);
...
h = figure
 ...
 plot(timeVec, (Furrow_S1_Avg + Furrow_S2_Avg)/2,'-r')
 hold on
  plot(timeVec,(Pole_S1_Avg + Pole_S2_Avg)/2,'-b')
