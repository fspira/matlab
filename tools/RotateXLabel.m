...
% newLabels - Cell or character array containing the desired xtick
labels
%
% Output:
...
%Optimize space by bringing the xtick labels closer to the bottom
x-axis
...
%Set the horizontal alignment differently for positive and negative
angles
if angleRotation >= 0
