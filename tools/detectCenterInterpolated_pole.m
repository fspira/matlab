function [ redMax1_new ] = detectCenterInterpolated_pole(redStackMid,flank1Tmp,rMark1,cMark1)
redStackMid(:,:) = 0;
...
%flank1Tmp = flank2Tmp
   ...
   %hLine=1
    for subrun = 1: 25
        ...
        redStackMid_center(hLine, cMark1) = 25000;
        redStackMid_center(hLine, cMark1+1) = 25000;
        hLine = hLine +1
